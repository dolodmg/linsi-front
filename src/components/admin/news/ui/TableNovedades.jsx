...
import { useNewsEditStore } from '@/store/store';
import ModalAddNew from '@/components/admin/news/add/addModal';
import EditModal from '@/components/admin/news/edit/editModal';
import ModalDeleteNew from '@/components/admin/news/delete/deleteModal';
